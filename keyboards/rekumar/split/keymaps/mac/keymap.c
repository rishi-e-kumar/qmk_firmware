...
[_LOWER] = LAYOUT( \
   ...
   KC_LCTL,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,KC_LCBR,       KC_RCBR,G(KC_LEFT),XXXXXXX,XXXXXXX,G(KC_RGHT),KC_RSFT, \
...
[_RAISE] = LAYOUT( \
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PIPE, KC_LABK,    KC_RABK, XXXXXXX, KC_MPRV, KC_MPLY, KC_MNXT, XXXXXXX, \
                   KC_LGUI,KC_LALT, LSFT(KC_SPC), LOWER,   RAISE,  LCTL_T(KC_DEL), LALT_T(KC_ENT)                 \
