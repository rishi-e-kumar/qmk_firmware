...
[_MOVE] = LAYOUT( \
   ...
   KC_LSFT,XXXXXXX,KC_LALT,KC_LSFT,KC_LCTL,KC_LGUI,      KC_LEFT,KC_DOWN,KC_UP,KC_RGHT,XXXXXXX,XXXXXXX, \
   KC_LCTL,XXXXXXX,C(KC_X),C(KC_C),C(KC_V),XXXXXXX,      C(G(KC_LEFT)),XXXXXXX,XXXXXXX,C(G(KC_RGHT)),C(KC_SLSH), KC_RSFT, \
    KC_LGUI,LT(_MOVE, KC_SPC), LT(_LOWER, KC_SPC), MO(_NUM),      KC_RALT,  LT(_RAISE, KC_BSPC),LSFT_T(KC_ENT)   \
),
...
[_LOWER] = LAYOUT( \
   KC_ESC,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, \
   KC_TAB,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,       KC_COLN,KC_AMPR,KC_TILD,KC_EXLM,KC_AT,KC_COMM, \
   KC_LSFT,XXXXXXX,XXXXXXX,KC_SPC,KC_SPC,XXXXXXX,       KC_ASTR,KC_PLUS,KC_EQL, KC_MINS,KC_SLSH,KC_BSLS, \
...
[_RAISE] = LAYOUT( \
  ...
  KC_TAB , XXXXXXX, KC_DQUO, KC_LBRC, KC_RBRC, KC_COLN,       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  KC_F12, \
  KC_LSFT , KC_AT, KC_QUOT, KC_LPRN, KC_RPRN, KC_UNDS,       XXXXXXX, KC_VOLD, KC_MUTE, KC_VOLU,XXXXXXX,  XXXXXXX, \
  KC_LCTL , XXXXXXX, XXXXXXX, KC_LCBR, KC_RCBR, KC_HASH,       XXXXXXX, KC_MPRV, KC_MPLY, KC_MNXT,XXXXXXX, KC_RSFT, \
    KC_LGUI,LT(_MOVE, KC_SPC), LT(_LOWER, KC_SPC), MO(_NUM),      KC_RALT,  LT(_RAISE, KC_DEL),LSFT_T(KC_ENT)   \
...
[_NUM] = LAYOUT( \
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_CIRC, KC_PERC,        XXXXXXX, KC_7, KC_8, KC_9, XXXXXXX, XXXXXXX, \
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PLUS, KC_MINS,        XXXXXXX, KC_4, KC_5, KC_6, KC_COMM, XXXXXXX, \
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_ASTR, KC_SLSH,        KC_MINS, KC_1, KC_2, KC_3, KC_DOT, KC_ENT, \
