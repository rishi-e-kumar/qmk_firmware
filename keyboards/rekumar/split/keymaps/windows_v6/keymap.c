...
[_QWERTY] = LAYOUT(
    ...
    KC_LSFT,  KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,               KC_N,   KC_M,   KC_COMM,KC_SCLN, KC_SLSH, KC_RSFT, \
                      KC_TAB,SFT_SPC, TT(_LOWER), KC_LEAD,             KC_ESC, RAISEBSPC, KC_SFTENT   \
),
...
[_RAISE] = LAYOUT(
  ...
  KC_LSFT , KC_PERC, KC_LABK, KC_PIPE, KC_RABK, KC_CIRC,      C(G(KC_LEFT)),XXXXXXX,XXXXXXX,C(G(KC_RGHT)),C(KC_SLSH), KC_RSFT, \
                      KC_TAB,SFT_SPC, LOWER, KC_LALT,         KC_ESC, RAISEDEL, KC_SFTENT   \
...
[_ADJUST] =  LAYOUT(
  ...
  XXXXXXX, XXXXXXX, KC_MPRV, KC_MPLY, KC_MNXT, XXXXXXX,                      XXXXXXX, KC_F1, KC_F2, KC_F3, KC_F10, XXXXXXX, \
                      KC_TAB,SFT_SPC, LOWER,  KC_LALT,                       KC_ESC,  RAISE,  KC_SFTENT   \
),
