...
[_QWERTY] = LAYOUT(
    ...
    KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,               KC_N,   KC_M,   KC_COMM,KC_SCLN, TT(_MOUSE), \
            KC_TAB,SFT_SPC, TT(_LOWER),                 RAISEBSPC, KC_SFTENT, KC_ESC   \
),


/* Lower */
[_LOWER] = LAYOUT(
   KC_QUES,KC_DQUO,KC_LBRC,KC_RBRC,KC_COLN,        KC_ASTR, KC_7,    KC_8,    KC_9,   KC_CIRC, \
   KC_COLN,KC_QUOT,KC_LPRN,KC_RPRN,KC_UNDS,       KC_PLUS, KC_4,    KC_5,    KC_6,   KC_DOT, \
...
[_RAISE] = LAYOUT(
  ...
  KC_PERC, KC_LABK, KC_PIPE, KC_RABK, KC_CIRC,      C(G(KC_LEFT)),XXXXXXX,XXXXXXX,C(G(KC_RGHT)),C(KC_SLSH), \
...
[_MOUSE] =  LAYOUT(
  ...
  XXXXXXX, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D,              XXXXXXX, KC_VOLD, KC_MUTE, KC_VOLU, XXXXXXX, \
